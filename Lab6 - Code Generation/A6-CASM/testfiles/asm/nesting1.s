...
main:
        ...
        # executing 'int a = 2;'
        movq $2, %rax
        movq %rax, -24(%rbp)	 # move %rax to a

        # executing 'int b = f();'
        call f
        movq %rax, -32(%rbp)	 # move %rax to b
# return stmt 
    	movq -24(%rbp), %rax 	 # put a into  %rax
        pushq %rax
    	movq -32(%rbp), %rax 	 # put b into  %rax
        movq %rax, %rbx
        popq %rax
        imulq %rbx, %rax
    	movq %rbp, %rsp
...
f:
        ...
        # executing 'int x = 3;'
        movq $3, %rax
        movq %rax, -8(%rbp)	 # move %rax to x

        # executing 'int y = 4;'
        movq $4, %rax
        movq %rax, -16(%rbp)	 # move %rax to y
# return stmt 
    	movq -8(%rbp), %rax 	 # put x into  %rax
        pushq %rax
    	movq -16(%rbp), %rax 	 # put y into  %rax
        movq %rax, %rbx
        popq %rax
        imulq %rbx, %rax
    	movq %rbp, %rsp
