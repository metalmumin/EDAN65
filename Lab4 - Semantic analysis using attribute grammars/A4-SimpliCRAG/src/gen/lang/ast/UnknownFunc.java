...
/**
 * @ast node
 * @declaredat /home/kuba/workspace43/A4-SimpliCRAG/src/jastadd/calc.ast:55
 * @production UnknownFunc : {@link FuncIdDecl};

 */
public class UnknownFunc extends FuncIdDecl implements Cloneable {
  /**
   ...
   */
  public UnknownFunc(String p0) {
    setID(p0);
  }
  /**
   * @declaredat ASTNode:15
   */
  public UnknownFunc(beaver.Symbol p0) {
    setID(p0);
  }
  /**
   * @apilevel low-level
